...
export const metadata: Metadata = {
  ...
  description: "Gli ultimi arrivi a Revenge Gym: sei macchine nuove già in sala e la Super Vertical Leg Press Panatta in arrivo. Il catalogo completo è nel menu Per gruppi muscolari.",
