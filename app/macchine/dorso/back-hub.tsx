  ...
  return (
    <main className={styles.page} id="top">
      ...
      <section className={styles.hero}>
        ...
        <img className={styles.heroAthlete} src="/photos/athletes/dorso-athlete-hero.webp" alt="Atleta dedicato all’allenamento del dorso" />
