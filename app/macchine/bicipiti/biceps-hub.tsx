...
export default function BicepsHub() {
  const [menuOpen, setMenuOpen] = useState(false);
  const [zonesOpen, setZonesOpen] = useState(false);
  const loop = [...bicepsMachines, ...bicepsMachines];
  return (
    <main className={styles.page} id="top">
      ...
      <header className={styles.nav}>
        ...
        <nav className={menuOpen ? styles.open : ""} aria-label="Menu allenamento bicipiti">
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroContent}>
          ...
          <h1>
            {bicepsZone.heroTitle[0]}
            <br />
            {bicepsZone.heroTitle[1]}
            <br />
            <em>{bicepsZone.heroTitle[2]}</em>
          </h1>
          <p>{bicepsZone.heroLead}</p>
          <div className={styles.heroMeta}>
            <div>
              <strong>{String(bicepsMachines.length).padStart(2, "0")}</strong>
        ...
        <div className={styles.marqueeWrap} aria-label="Galleria macchine bicipiti">
      ...
      <section className={styles.manifesto} id="qualita">
        <div className={styles.manifestoCopy}>
          ...
          <h2>
            {bicepsZone.manifestoTitle[0]}
            <br />
            <em>{bicepsZone.manifestoTitle[1]}</em>
          </h2>
        </div>
        <div className={styles.manifestoText}>
          {bicepsZone.manifesto.map((paragraph) => (
      ...
      <section className={styles.index} id="elenco">
        <div className={styles.sectionIntro}>
          ...
          <p>Quattro postazioni per allenare i bicipiti da traiettorie diverse. Apri ogni scheda per scoprire funzione, muscoli coinvolti, impostazione, programmazione ed errori comuni.</p>
        </div>
      ...
      <section className={styles.cta}>
        ...
        <p>Vieni a Revenge Gym e costruisci la tua progressione bicipiti con lo staff.</p>
