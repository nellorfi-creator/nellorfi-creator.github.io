...
export default function ChestMachineDetail({ machine, prev, next }: Props) {
  ...
  return (
    <main className={styles.page} id="top">
      ...
      <footer className={styles.footer}><Link href="/?skipIntro=1#home" className={styles.logo} aria-label="Revenge Gym home"><SiteImage src="/brand/revenge-gym-logo.png" alt="Revenge Gym" /></Link><p>{machine.brand} · Petto</p><p className={styles.footerLegal}><span>© 2026 Revenge Gym</span><span className={styles.byNello} style={{ textTransform: "none" }}>© by nello 2026</span></p></footer>
    </main>
  );
}
