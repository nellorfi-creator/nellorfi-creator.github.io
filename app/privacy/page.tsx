  ...
  return (
    <main className="legal-page">
      ...
      <article>
        ...
        <h2>Conservazione</h2>
        <p>Messaggi del modulo: per il tempo necessario a gestire la richiesta e gli eventuali adempimenti successivi, di regola non oltre 12 mesi dalla chiusura del contatto, salvo esigenze difensive. Codici e totali del contatore: per il funzionamento della statistica interna, senza scadenza automatica giornaliera. Log di hosting: secondo le policy di GitHub e Cloudflare. Dati di Analytics: presso Google, secondo la sua informativa, a ogni visita. Dati della mappa: presso Google, secondo la sua informativa, e solo dopo il consenso al caricamento.</p>
