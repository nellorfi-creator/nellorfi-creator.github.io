  ...
  return (
    <main className="legal-page">
      ...
      <article>
        ...
        <p>La pagina contatti non carica Google Maps in automatico. Solo se scegli «Carica Google Maps», il browser si collega a Google Ireland Ltd. e possono essere trasmessi dati tecnici (incluso l’indirizzo IP) e impostati cookie di Google, secondo l’informativa disponibile su policies.google.com. In alternativa puoi aprire l’indirizzo in una nuova scheda con il link «Apri in Google Maps», senza incorporare la mappa nel sito.</p>
