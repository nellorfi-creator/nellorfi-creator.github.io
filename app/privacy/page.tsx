  ...
  return (
    <main className="legal-page">
      ...
      <article>
        ...
        <p><strong>Google Analytics.</strong> Solo se clicchi «Accetta» nella barra in basso, il browser carica Google Analytics 4 (Google Ireland Ltd. / Google LLC). Si registrano pagine visitate, sorgente del traffico (ad esempio Instagram o ricerca Google), tipo di dispositivo e dati tecnici di connessione. Non usiamo questi dati per pubblicità. Base giuridica: consenso (art. 6, par. 1, lett. a). Se rifiuti, Analytics non parte. Puoi cambiare scelta cancellando i dati del sito nel browser.</p>
